    ...
    return (
        <div>
            <section className="py-5 text-center container">
                <div className="row py-lg-5">
                    <div className="col-lg-6 col-md-8 mx-auto">
                        <h1 className="fw-light">{storeName}</h1>
                        <img className="menu-logo" src={logo} alt={`${storeName} logo`} loading="lazy" />
                    </div>
                </div>
            </section>
            ...
            <button id="cart" type="button" hidden={itemsNumber === 0}>
                ...
                <span className="circle right" id="price">{itemsPrice}€</span>
            </button>
            </Link>
        </div>
    );
